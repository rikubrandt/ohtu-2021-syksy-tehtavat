...
class TestKauppa(unittest.TestCase):
    ...
    def test_kaksi_ostosta_korissa_kutsutaan_oikeilla_arvoilla(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_tuote_jota_varastossa_tuote_joka_loppu_tilisiirto(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_poista_korista_lisaamisen_jalkeen(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
